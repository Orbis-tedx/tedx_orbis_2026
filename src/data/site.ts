...
export const site = {
  ...
  email: val("VITE_CONTACT_EMAIL", "info.pune2@theorbisschool.com"),
  phone: val("VITE_CONTACT_PHONE", "+91-7373 735 063 / +91-7373 735 163"),
  whatsapp: val("VITE_WHATSAPP_NUMBER", "8484 967 988"),
